...
Load this file when the developer asks to verify before pushing, wants to run Pushback verification, or when a `git push` was blocked by Pushback and setup is already present.
